...
CREATE TABLE IF NOT EXISTS log_agent_runs (
    ...
    agent_name ENUM('Orchestrator','CodeChecker','FE','BE','Lint','Migration','ContractSync','SpecSync','Deploy','PostTest') NOT NULL,
...
CREATE TABLE IF NOT EXISTS log_task_state (
    ...
    failed_stage ENUM('STAGE1','STAGE2','STAGE3','MIGRATION','CONTRACT_SYNC','SPEC_SYNC','AGENT_GUARD') NULL,
