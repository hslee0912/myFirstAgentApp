...
/**
 * Convenience: list the env keys this project's UI is allowed to edit.
 ...
 */
const UI_EDITABLE_KEYS = Object.freeze([
  // Mode toggles
  'COMMIT_MODE',
  'VALIDATION_MODE',
  'DEPLOY_MODE',
...
module.exports = { readEnv, updateEnv, UI_EDITABLE_KEYS };
